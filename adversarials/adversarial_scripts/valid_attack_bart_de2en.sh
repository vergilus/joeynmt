...
save_path='/home/nfs01/zouw/policy/attack_bart_de2en_log'

python3 -m adversarials.test_attack \
	--ckpt_path "${save_path}"\
	--output_path "${save_path}/in_perturbed.$1" \
	--use_gpu \
	--source_path "/home/nfs01/zouw/temp/en-de_data/newstest20$1.sub.de"
...
python3 -m plm_mt.main translate \
	/home/nfs01/zouw/models/wmt_deen_TF_bart/config.yaml \
	--ckpt /home/nfs01/zouw/models/wmt_deen_TF_bart/best.ckpt \
...
cat ${save_path}/perturbed_trans.out | sacrebleu --tok intl /home/nfs01/zouw/data/wmt14_en-de_processed/newstest20$1.tok.en
